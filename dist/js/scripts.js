/* version: 15-11-2022 15:55:27 */(self["webpackChunk"] = self["webpackChunk"] || []).push([[1],{
...
var jquery_ui_min = __webpack_require__(2);
// EXTERNAL MODULE: ../src/scripts/_libs/jquery.ui.touch-punch.min.js
var jquery_ui_touch_punch_min = __webpack_require__(3);
...
!function (e) {
  ...
  l.cleanData = (n = l.cleanData, function (e) {
    ...
    for (var t, i, s = h.call(arguments, 1), n = 0, a = s.length; n < a; n++) {
      for (t in s[n]) {
        i = s[n][t], o.call(s[n], t) && void 0 !== i && (l.isPlainObject(i) ? e[t] = l.isPlainObject(e[t]) ? l.widget.extend({}, e[t], i) : l.widget.extend({}, i) : e[t] = i);
      }
    }
    return e;
    ...
    option: function option(e, t) {
      ...
      if ("string" == typeof e) if (a = {}, e = (i = e.split(".")).shift(), i.length) {
        for (s = a[e] = l.widget.extend({}, this.options[e]), n = 0; n < i.length - 1; n++) {
          s[i[n]] = s[i[n]] || {}, s = s[i[n]];
        }
    ...
    _setOptionClasses: function _setOptionClasses(e) {
      var t, i, s;
      for (t in e) {
        s = this.classesElementLookup[t], e[t] !== this.options.classes[t] && s && s.length && (i = l(s.get()), this._removeClass(s, t), i.addClass(this._classes({
          element: i,
          keys: t,
          classes: e,
          add: !0
    ...
    _classes: function _classes(n) {
      ...
      function e(e, t) {
        for (var i, s = 0; s < e.length; s++) {
          i = o.classesElementLookup[e[s]] || l(), i = n.add ? (function () {
            var i = [];
    ...
    _trigger: function _trigger(e, t, i) {
      var s,
        n,
        a = this.options[e];
      if (i = i || {}, (t = l.Event(t)).type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase(), t.target = this.element[0], n = t.originalEvent) for (s in n) {
        s in t || (t[s] = n[s]);
      }
  ...
  l.widget("ui.mouse", {
    ...
    _createHandles: function _createHandles() {
      ...
      for (i.length > n && (i.slice(n).remove(), i = i.slice(0, n)), e = i.length; e < n; e++) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [1], function() { return __webpack_require__(1); })
